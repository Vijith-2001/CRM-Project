...
from .models import Student,DistrictChoices
...
class StudentRegisterForm(forms.ModelForm):
    ...
    class Meta:
        ...
        #if all fields in the models are used
        ...
        exclude = ['adm_number','join_date','uuid','active_status','profile']
                                                        ...
                                                        #copy the below class from forms.html
    ...
    def clean(self):
        ...
        if len(pincode) < 6:
            ...
            self.add_error('pincode','pincode must be six digits')
    ...
    def __init__(self,*args,**kwargs):           #for giving required for image in forms only. When updated, it is not required
